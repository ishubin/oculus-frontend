...
{
    var str = "../document/testcase-search";
...
function onSaveFilter(){
    var request = "document/testcase-search"+generateRequest(document.forms.searchFilter);
...
function onExportXLS(){
    var request = "../document/testcase-search-export.xls"+generateRequest(document.forms.searchFilter);
...
<form onsubmit="return onSubmitTestSearchForm(this);" method="get" name="searchFilter" action="../document/testcase-search">
                ...
                <tag:panel title="Project" id="project" align="left" width="100%" disclosure="true" closed="false">
					...
					<c:if test="${searchFilter.project!=null && searchFilter.project!='' && subprojects!=null}">
                    	...
                    	<select name="subProject" style="width:100%;">
	                        <option value="" style="color:gray;">Not selected</option>
