...
<div class="breadcrump" align="center">
    ...
    <img src="../images/breadcrump-arrow.png"/> Create Chart
</div>

<tag:panel align="center" title="Create Custom Statistic Chart" width="600px">
    <form:form method="post" commandName="customStatisticChart" action="../cstat/create-chart">
